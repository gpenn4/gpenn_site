...
export default function SpainPage() {
    return <div>
        <div className="gallery gap-4">
            {/* MALLORCA */}
            <h1 className="text-xl font-bold py-20">Mallorca</h1>
            <Image src="/photos/spain/mallorca1.jpg" alt="" width={300}
                height={100} />
            ...
            {/* BARCELONA */}
            <h1 className="text-xl font-bold py-20">Barcelona</h1>
            ...
            {/* TENERIFE */}
            <h1 className="text-xl font-bold py-20">Tenerife</h1>
            ...
            {/* LANZAROTE */}
            <h1 className="text-xl font-bold py-20">Lanzarote</h1>
            ...
            <Image src="/photos/spain/lanzarote9.JPG" alt="" width={300}
                height={100} />
            <Image src="/photos/spain/lanzarote15.JPG" alt="Beach Stairs" width={125}
                height={100} />        
