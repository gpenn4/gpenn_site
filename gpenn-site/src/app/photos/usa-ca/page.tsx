...
export default function USPage() {
    return <div>
        <div className="gallery gap-4">
            <Image src="/photos/usa/Aspen3.jpg" alt="" width={300}
                height={100} />
            {/* <Image src="/photos/usa/Aspen4.jpg" alt="" width={300}
                height={100} /> */}
            ...
            <Image src="/photos/usa/aspen9.jpg" alt="" width={300}
                height={100} />
            <Image src="/photos/usa/aspen10.JPG" alt="" width={300}
                height={100} />
            ...
            <Image src="/photos/usa/ny10.jpg" alt="" width={300}
                height={100} />
            <Image src="/photos/usa/ny11.jpg" alt="" width={125}
                height={100} />
            <Image src="/photos/usa/ny12.jpg" alt="" width={125}
                height={100} />

            <Image src="/photos/usa/nh1.jpg" alt="" width={300}
                height={100} />
            <Image src="/photos/usa/nh2.jpg" alt="" width={125}
                height={100} />
